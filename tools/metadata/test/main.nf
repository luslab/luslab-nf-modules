...
workflow {
    ...
    // Check count
    meta_se_assert_channel_count( meta_se.out.metadata, "metadata", 3)
    meta_pe_assert_channel_count( meta_pe.out.metadata, "metadata", 3)
    // smartseq2_fastq_metadata_assert_channel_count( smartseq2_fastq_metadata.out.metadata, "metadata", 6)
    tenx_fastq_metadata_assert_channel_count( tenx_fastq_metadata.out.metadata, "metadata", 2)
}